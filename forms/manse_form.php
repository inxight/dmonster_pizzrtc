...
<div id="InPut">
		<table cellpadding="0" cellspacing="0">
			...
			<tR>
				<tD align="center" style="background-image:url('/images/input_img/bottom_bg.gif'); background-repeat:repeat-y; background-position:center 0px;"><?include "../forms/input_form.php";?></tD>
			</tR>
			<tr>
