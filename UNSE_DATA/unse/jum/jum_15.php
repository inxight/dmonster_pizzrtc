...
<?
$UNSE_TITLE = "육임단시";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>육임단시</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "N";
$manse_data = "N";
$ohang_data = "N";
$yukhyo_data = "N";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/61.jpg'></td></tr>
...
<?S_SB_img("S016", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/S/S016.php";?>
<?S_CI_img(substr("S016",0, 1), intval(str_Replace(substr("S016",0, 1), "", "S016")).".jpg")?>
<?=$Tb_S016?>
<br><Br><table cellpadding='0' cellspacing='0'><tr><td><?S_graph($Tb_S016_numerical, "육임단시")?></tD></tr></table>
