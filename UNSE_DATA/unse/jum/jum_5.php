...
<?
$UNSE_TITLE = "단시점";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>단시점</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/51.jpg'></td></tr>
...
<?S_SB_img("J050", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/J/J050.php";?>
<?S_CI_img(substr("J050",0, 1), intval(str_Replace(substr("J050",0, 1), "", "J050")).".jpg")?>
<?=$Tb_J050?>
