...
<?
$UNSE_TITLE = "직장부하운";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>직장부하운</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/60.jpg'></td></tr>
...
<?S_SB_img("N012", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/N/N012.php";?>
<?S_CI_img(substr("N012",0, 1), intval(str_Replace(substr("N012",0, 1), "", "N012")).".jpg")?>
<?=$Tb_N012?>
<br><Br><table cellpadding='0' cellspacing='0'><tr><td><?S_graph($Tb_N012_numerical, "직장부하운")?></tD></tr></table>
