...
<?
$UNSE_TITLE = "육효";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>육효</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "N";
$manse_data = "N";
$ohang_data = "N";
$yukhyo_data = "N";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/52.jpg'></td></tr>
...
<?S_SB_img("J051", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/J/J051.php";?>
<?S_CI_img(substr("J051",0, 1), intval(str_Replace(substr("J051",0, 1), "", "J051")).".jpg")?>
<?=$Tb_J051?>
