...
<?
$UNSE_TITLE = "사업합작운";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>사업합작운</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/58.jpg'></td></tr>
...
<?S_SB_img("N010", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/N/N010.php";?>
<?S_CI_img(substr("N010",0, 1), intval(str_Replace(substr("N010",0, 1), "", "N010")).".jpg")?>
<?=$Tb_N010?>
<br><Br><table cellpadding='0' cellspacing='0'><tr><td><?S_graph($Tb_N010_numerical, "사업합작운")?></tD></tr></table>
