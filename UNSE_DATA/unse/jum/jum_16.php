...
<?
$UNSE_TITLE = "64괘 운세분석";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>64괘 운세분석</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "N";
$manse_data = "N";
$ohang_data = "N";
$yukhyo_data = "N";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/62.jpg'></td></tr>
...
<?S_SB_img("J015", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/J/J015.php";?>
<?S_CI_img(substr("J015",0, 1), intval(str_Replace(substr("J015",0, 1), "", "J015")).".jpg")?>
<?=$Tb_J015?>
</td></tr><?=$include_bottom_Top_C2?><tr><td height='15'></td></tr>
