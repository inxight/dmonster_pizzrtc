...
<?
$UNSE_TITLE = "형제운";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>형제운</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='#1'><font color=#FFFFFF><b>행운</b></font></a>";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/54.jpg'></td></tr>
...
<?S_SB_img("S135", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/S/S135.php";?>
<?S_CI_img(substr("S135",0, 1), intval(str_Replace(substr("S135",0, 1), "", "S135")).".jpg")?>
<?=$Tb_S135?>
