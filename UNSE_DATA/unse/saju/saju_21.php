...
<?
$UNSE_TITLE = "태어난계절에따른운";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>태어난계절에따른운</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/21.jpg'></td></tr>
...
<?S_SB_img("S113", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/S/S113.php";?>
<?S_CI_img(substr("S113",0, 1), intval(str_Replace(substr("S113",0, 1), "", "S113")).".jpg")?>
<?=$Tb_S113?>
...
<?S_SB_img("T022", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/T/T022.php";?>
<?S_CI_img(substr("T022",0, 1), intval(str_Replace(substr("T022",0, 1), "", "T022")).".jpg")?>
<?=$Tb_T022?>
</td></tr><?=$include_bottom_Top_C2?>
