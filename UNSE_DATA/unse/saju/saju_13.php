...
<?
$UNSE_TITLE = "살풀이";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>살풀이</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/13.jpg'></td></tr>
...
<?S_SB_img("S126", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/S/S126.php";?>
<?=$Tb_S126?>
...
<tr><td><br><Br><table cellpadding='0' cellspacing='0'><tr><td><?S_graph($Tb_S007_numerical, "현재의 길흉사")?></tD></tr></table>
</td></tr><?=$include_bottom_Top_C2?>
</table>
