...
<?
$UNSE_TITLE = "만세력 (페이지)";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>만세력 (페이지)</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "N";
$yukhyo_data = "N";
...
<?S_SB_img("F026", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/F/F026.php";?>
<?S_CI_img(substr("F026",1, 1), str_Replace("F026", "", substr("F026",1, 1)).".jpg")?>
<?=$Tb_F026?>
