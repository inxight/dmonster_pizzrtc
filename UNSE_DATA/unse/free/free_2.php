...
<?
$UNSE_TITLE = "별자리운세";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>별자리운세</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "N";
$manse_data = "N";
$ohang_data = "N";
$yukhyo_data = "N";
...
<?S_SB_img("F013", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/F/F013.php";?>
<?S_CI_img(substr("F013",1, 1), "13.jpg")?>
<?=$Tb_F013?>
