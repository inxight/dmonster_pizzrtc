...
<?
$UNSE_TITLE = "바이오리듬";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>바이오리듬</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "N";
$manse_data = "N";
$ohang_data = "N";
$yukhyo_data = "N";
...
<?S_SB_img("F024", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/F/F024.php";?>
<?S_CI_img(substr("F024",1, 1), "24.jpg")?>
<?=$Tb_F024?>
