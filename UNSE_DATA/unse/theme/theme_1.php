...
<?
$UNSE_TITLE = "천생운";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>천생운</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "N";
$manse_data = "N";
$ohang_data = "N";
$yukhyo_data = "N";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/63.jpg'></td></tr>
...
<?S_SB_img("T029", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/T/T029.php";?>
<?S_CI_img("T","29.jpg")?>
<?=$Tb_T029?>
</td></tr><?=$include_bottom_Top_C2?>
<?S_SB_img("T017", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/T/T017.php";?>
<?S_CI_img("T","17.jpg")?>
<?=$Tb_T017?>
</td></tr><?=$include_bottom_Top_C2?>
<?S_SB_img("T023", $solution_var);?>
<tr><td style="<?=$fontcolor?>">
<?include "../../solve/T/T023.php";?>
<?S_CI_img("T","23.jpg")?>
<?=$Tb_T023?>
</td></tr>
<tr><td><table cellpadding='0' cellspacing='0'><tr><td><br><Br><?S_graph($Tb_T023_numerical, "행운의요소")?></tD></tr></table></td></tr><?=$include_bottom_Top_C2?>
</table>
