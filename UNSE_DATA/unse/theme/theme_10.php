...
<?
$UNSE_TITLE = "현재 운세풀이";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>현재 운세풀이</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "N";
$manse_data = "N";
$ohang_data = "N";
$yukhyo_data = "N";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/72.jpg'></td></tr>
...
<?S_SB_img("S013", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/S/S013.php";?>
<?S_CI_img(substr("S013",0, 1), intval(str_Replace(substr("S013",0, 1), "", "S013")).".jpg")?>
<?=$Tb_S013?>
<br><Br><table cellpadding='0' cellspacing='0'><tr><td><?S_graph($Tb_S013_numerical, "현재 운세풀이")?></tD></tr></table>
...
<?S_SB_img("T023", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/T/T023.php";?>
<?S_CI_img(substr("T023",0, 1), intval(str_Replace(substr("T023",0, 1), "", "T023")).".jpg")?>
<?=$Tb_T023?>
<br><Br><table cellpadding='0' cellspacing='0'><tr><td><?S_graph($Tb_T023_numerical, "행운의요소")?></tD></tr></table>
</td></tr><?=$include_bottom_Top_C2?>
</table>
