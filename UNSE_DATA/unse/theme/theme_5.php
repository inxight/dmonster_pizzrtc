...
<?
$UNSE_TITLE = "나의길흉숫자";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>나의길흉숫자</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='#1'><font color=#FFFFFF><b>행운</b></font></a>";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/67.jpg'></td></tr>
...
<?S_SB_img("T061", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/T/T061.php";?>
<?S_CI_img(substr("T061",0, 1), intval(str_Replace(substr("T061",0, 1), "", "T061")).".jpg")?>
<?=$Tb_T061?>
