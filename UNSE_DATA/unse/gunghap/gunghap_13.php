...
<?
$UNSE_TITLE = "속궁합";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>속궁합</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/41.jpg'></td></tr>
...
<?S_SB_img("G016", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/G/G016.php";?>
<?S_CI_img(substr("G016",0, 1), intval(str_Replace(substr("G016",0, 1), "", "G016")).".jpg")?>
<?=$Tb_G016?>
<br><Br><table cellpadding='0' cellspacing='0'><tr><td><?S_graph($Tb_G016_numerical, "섹스궁합")?></tD></tr></table>
