...
<?
$UNSE_TITLE = "섹스 토정비결";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>섹스 토정비결</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='#1'><font color=#FFFFFF><b>사랑분석</b></font></a>";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/33.jpg'></td></tr>
...
<?S_SB_img("Y004", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/Y/Y004.php";?>
<?S_CI_img(substr("Y004",0, 1), intval(str_Replace(substr("Y004",0, 1), "", "Y004")).".jpg")?>
...
<table cellpadding='0' cellspacing='0'><tr><td style="padding-left:20px"><?S_graph($Tb_S006_numerical, "현재의 이성연애운")?></tD></tr></table>
<!-- 운세결과물 출력 종료 -->
