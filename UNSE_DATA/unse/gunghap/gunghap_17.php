...
<?
$UNSE_TITLE = "섹스운";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>섹스운</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/45.jpg'></td></tr>
...
<?S_SB_img("S073", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/S/S073.php";?>
<?S_CI_img(substr("S073",0, 1), intval(str_Replace(substr("S073",0, 1), "", "S073")).".jpg")?>
<?=$Tb_S073?>
</td></tr><?=$include_bottom_Top_C2?>
</table>
