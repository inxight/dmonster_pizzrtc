...
<?
$UNSE_TITLE = "애인부부운";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>애인부부운</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/37.jpg'></td></tr>
...
<?S_SB_img("G031", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/G/G031.php";?>
<?S_CI_img(substr("G031",0, 1), intval(str_Replace(substr("G031",0, 1), "", "G031")).".jpg")?>
<?=$Tb_G031?>
...
<?S_SB_img("G007", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/G/G007.php";?>
<?S_CI_img(substr("G007",0, 1), intval(str_Replace(substr("G007",0, 1), "", "G007")).".jpg")?>
<?=$Tb_G007?>
</td></tr><?=$include_bottom_Top_C2?>
</table>
