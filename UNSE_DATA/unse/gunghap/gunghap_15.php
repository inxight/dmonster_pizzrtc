...
<?
$UNSE_TITLE = "애정운";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>애정운</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/43.jpg'></td></tr>
...
<?include "../../solve/S_S094_S101_sol.php";?>
...
<?S_SB_img("S097", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/S/S097.php";?>
<?S_CI_img(substr("S097",0, 1), intval(str_Replace(substr("S097",0, 1), "", "S097")).".jpg")?>
<?=$Tb_S097?>
</td></tr><?=$include_bottom_Top_C2?>
