...
<?
$UNSE_TITLE = "침실 섹스궁합";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>침실 섹스궁합</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='#1'><font color=#FFFFFF><b>연애운분석</b></font></a>";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/34.jpg'></td></tr>
...
<?S_SB_img("G020", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/G/G020.php";?>
<?S_CI_img(substr("G020",0, 1), intval(str_Replace(substr("G020",0, 1), "", "G020")).".jpg")?>
<?=$Tb_G020?>
<br><Br><table cellpadding='0' cellspacing='0'><tr><td><?S_graph($Tb_G020_numerical, "침실섹스궁합")?></tD></tr></table>
