...
<?
$UNSE_TITLE = "정통궁합(속궁합,겉궁합)";
$title_var = "<a href='#0'><font color='#FFFFFF'><b>정통궁합(속궁합,겉궁합)</b></font></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='#1'><font color=#FFFFFF><b>궁합분석</b></font></a>";
$o_manse_data = "Y";
$manse_data = "Y";
$ohang_data = "Y";
$yukhyo_data = "Y";
...
<tR><td align='center'><A name='#0'><img src='/UNSE_DATA/images/c2_img/MB_img/29.jpg'></td></tr>
...
<?S_SB_img("G022", $solution_var);?><tr><td style="<?=$fontcolor?>">
<?include "../../solve/G/G022.php";?>
<?S_CI_img(substr("G022",0, 1), intval(str_Replace(substr("G022",0, 1), "", "G022")).".jpg")?>
<?=$Tb_G022?>
...
<tR><td align=center><A name="#1"><img src="http://interlife.co.kr/UNSE_DATA/images/c2_img/List_img/L62.jpg"></td></tr>
