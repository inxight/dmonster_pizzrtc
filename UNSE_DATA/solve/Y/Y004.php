<?
$sql = "SELECT DB_data, DB_data_1, DB_data_2, DB_data_3, DB_data_4, DB_data_5, DB_data_6, DB_data_7, DB_data_8, DB_data_9, DB_data_10, DB_data_11, DB_data_12 FROM Y004 WHERE DB_express = '".$my_day_e_org."'";
...
for ($i = 0 ; $i<$all; $i++) {
	...
	$Tb_Y004 = stripslashes($row[DB_data]);
...
<table cellpadding="0" cellspacing="0">
	<tR> 
		<tD style="<?=$fontcolor?>"><?=$Tb_Y004?><BR><BR></tD>
