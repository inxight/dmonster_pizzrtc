...
$sql = "select DB_data_1, DB_data_2, DB_data_3, DB_data_4, DB_data_5, DB_data_6, DB_data_7, DB_data_8, DB_data_9, DB_data_10, DB_data_11, DB_data_12 from S101 where DB_express = '".$my_day_h_org.$temp_03."'";
